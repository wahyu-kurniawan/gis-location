                    ...
                    <div class="card-body">
                        <form action="{{ route('centre-point.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                <div class="btn btn-primary btn-sm" onclick="getLocation()">Lokasi Saat ini</div>
...
@push('javascript')
    ...
    <script>
        ...
        //mendaptakan lokasi saat ini
        var x = document.querySelector("[name=location]");
        ...
        var curLocation = [-7.4730096,110.1785558];
